...
return new class extends Migration
{
    public function up()
    {
        ...
        if (!DB::table('settings')->where('key', 'external_link_active')->exists()) {
        ...
        if (!DB::table('settings')->where('key', 'app_store_active')->exists()) {
            DB::table('settings')->insert([
        ...
        if (!DB::table('settings')->where('key', 'play_store_active')->exists()) {
            DB::table('settings')->insert([
