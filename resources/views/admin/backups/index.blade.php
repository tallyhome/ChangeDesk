        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header d-flex justify-content-between align-items-center">
                    ...
                    <div class="d-flex">
                        <form action="{{ route('superadmin.backups.create') }}" method="POST" class="me-2">
                            @csrf
                                ...
                                <tbody>
                                    @foreach($backups as $backup)
                                        <tr>
                                            ...
                                            <td>{{ $backup['date'] }}</td>
                                            <td class="d-flex">
                                                <a href="{{ route('superadmin.backups.download', $backup['filename']) }}" class="btn btn-sm btn-info me-2">
